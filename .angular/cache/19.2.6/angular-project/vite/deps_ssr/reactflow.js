...
import {
  require_react_dom
} from "./chunk-QKCC3VKH.js";
import {
  require_react
} from "./chunk-UQ43AJUW.js";
import {
  __commonJS,
  __objRest,
  __spreadProps,
...
var require_use_sync_external_store_shim_production = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.production.js"(exports) {
    ...
    var useState3 = React7.useState;
    var useEffect5 = React7.useEffect;
    var useLayoutEffect = React7.useLayoutEffect;
    var useDebugValue2 = React7.useDebugValue;
    function useSyncExternalStore$2(subscribe, getSnapshot) {
      var value = getSnapshot(), _useState = useState3({
        inst: {
          value,
          getSnapshot
        }
...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    "production" !== process.env.NODE_ENV && function() {
      ...
      function useSyncExternalStore$2(subscribe, getSnapshot) {
        didWarnOld18Alpha || void 0 === React7.startTransition || (didWarnOld18Alpha = true, console.error("You are using an outdated, pre-release alpha of React 18 that does not support useSyncExternalStore. The use-sync-external-store shim will not work correctly. Upgrade to a newer pre-release."));
...
} = import_with_selector.default;
var identity = (arg) => arg;
function useStoreWithEqualityFn(api, selector6 = identity, equalityFn) {
  const slice = useSyncExternalStoreWithSelector(api.subscribe, api.getState, api.getServerState || api.getInitialState, selector6, equalityFn);
  useDebugValue(slice);
  return slice;
}
...
function Panel(_a) {
  ...
  return import_react2.default.createElement("div", __spreadValues({
...
function Attribution({
  ...
  return import_react2.default.createElement(Panel, {
    position,
...
var EdgeText = (_a) => {
  ...
  const [edgeTextBbox, setEdgeTextBbox] = (0, import_react2.useState)({
    x: 0,
    y: 0,
    width: 0,
    height: 0
  ...
  return import_react2.default.createElement("g", __spreadValues({
    transform: `translate(${x - edgeTextBbox.width / 2} ${y - edgeTextBbox.height / 2})`,
    className: edgeTextClasses,
    visibility: edgeTextBbox.width ? "visible" : "hidden"
  }, rest), labelShowBg && import_react2.default.createElement("rect", {
...
var nodeToRect = (node) => __spreadProps(__spreadValues({}, node.positionAbsolute || {
  x: 0,
  y: 0
}), {
  width: node.width || 0,
...
var BaseEdge = ({
  ...
  return import_react2.default.createElement(import_react2.default.Fragment, null, import_react2.default.createElement("path", {
    id: id2,
    style: style2,
    d: path,
    fill: "none",
    ...
    markerEnd,
    markerStart
  }), interactionWidth && import_react2.default.createElement("path", {
    d: path,
    fill: "none",
    strokeOpacity: 0,
    strokeWidth: interactionWidth,
    className: "react-flow__edge-interaction"
  }), label && isNumeric(labelX) && isNumeric(labelY) ? import_react2.default.createElement(EdgeText$1, {
    x: labelX,
    y: labelY,
    label,
    labelStyle,
...
function getMouseHandler$1(id2, getState, handler) {
  return handler === void 0 ? handler : (event) => {
    ...
    if (edge) {
      handler(event, __spreadValues({}, edge));
    }
  };
}
...
var SimpleBezierEdge = (0, import_react2.memo)(({
  sourceX,
  sourceY,
  targetX,
  targetY,
  ...
  return import_react2.default.createElement(BaseEdge, {
    path,
    labelX,
    labelY,
    label,
...
var SmoothStepEdge = (0, import_react2.memo)(({
  sourceX,
  sourceY,
  targetX,
  targetY,
...
var StepEdge = (0, import_react2.memo)((props) => import_react2.default.createElement(SmoothStepEdge, __spreadProps(__spreadValues({}, props), {
  pathOptions: (0, import_react2.useMemo)(() => ({
    borderRadius: 0,
...
var StraightEdge = (0, import_react2.memo)(({
  sourceX,
  sourceY,
  targetX,
  targetY,
...
var BezierEdge = (0, import_react2.memo)(({
  sourceX,
  sourceY,
  targetX,
  targetY,
...
var reconnectEdge = (oldEdge, newConnection, edges, options = {
...
var updateEdge = (oldEdge, newConnection, edges, options = {
  shouldReplaceId: true
}) => {
...
function isValidHandle(handle, connectionMode, fromNodeId, fromHandleId, fromType, isValidConnection, doc) {
  ...
  const result = __spreadProps(__spreadValues({}, defaultResult()), {
...
function handlePointerDown({
  ...
  function onPointerMove(event2) {
    ...
    const {
      handle,
      validHandleResult
    } = getClosestHandle(event2, doc, pointToRendererPoint(connectionPosition, transform2, false, [1, 1]), connectionRadius, handleLookup, (handle2) => isValidHandle(handle2, connectionMode, nodeId, handleId, isTarget ? "target" : "source", isValidConnection, doc));
...
var Handle = (0, import_react2.forwardRef)((_a, ref) => {
  var _b = _a, {
    type = "source",
  ...
  const onConnectExtended = (params) => {
    ...
    const edgeParams = __spreadValues(__spreadValues({}, defaultEdgeOptions), params);
    if (hasDefaultEdges) {
      const {
        edges,
        setEdges
...
var DefaultNode = ({
  ...
  return import_react2.default.createElement(import_react2.default.Fragment, null, import_react2.default.createElement(Handle$1, {
    type: "target",
    position: targetPosition,
    isConnectable
  }), data?.label, import_react2.default.createElement(Handle$1, {
    type: "source",
...
var InputNode = ({
  ...
  isConnectable,
  sourcePosition = Position.Bottom
}) => import_react2.default.createElement(import_react2.default.Fragment, null, data?.label, import_react2.default.createElement(Handle$1, {
  type: "source",
  position: sourcePosition,
  isConnectable
}));
...
var OutputNode = ({
  ...
  isConnectable,
  targetPosition = Position.Top
}) => import_react2.default.createElement(import_react2.default.Fragment, null, import_react2.default.createElement(Handle$1, {
  type: "target",
  position: targetPosition,
  isConnectable
}), data?.label);
...
var selector$e = (s) => ({
  ...
  selectedEdges: s.edges.filter((e) => e.selected).map((e) => __spreadValues({}, e))
});
...
var SelectionListener = (0, import_react2.memo)(({
  onSelectionChange
}) => {
  const store = useStoreApi();
  const {
...
function Wrapper$1({
  ...
  if (onSelectionChange || storeHasSelectionChange) {
    return import_react2.default.createElement(SelectionListener, {
      onSelectionChange
    });
  }
  return null;
...
var StoreUpdater = ({
  ...
  const {
    ...
    setNodeExtent,
    reset
  } = useStore(selector$d, shallow$1);
  const store = useStoreApi();
  (0, import_react2.useEffect)(() => {
    const edgesWithDefaults = defaultEdges?.map((e) => __spreadValues(__spreadValues({}, e), defaultEdgeOptions));
...
function A11yDescriptions({
  ...
  return import_react2.default.createElement(import_react2.default.Fragment, null, import_react2.default.createElement("div", {
    ...
    style
  }, "Press enter or space to select a node.", !disableKeyboardA11y && "You can then use the arrow keys to move the node around.", " Press delete to remove it and escape to cancel.", " "), import_react2.default.createElement("div", {
    id: `${ARIA_EDGE_DESC_KEY}-${rfId}`,
    style
  }, "Press enter or space to select an edge. You can then press delete to remove it or escape to cancel."), !disableKeyboardA11y && import_react2.default.createElement(AriaLiveMessage, {
    rfId
  }));
}
  ...
  nodeInternals.forEach((node) => {
    ...
    if (parentId || parentNodes?.[node.id]) {
      const {
        ...
        y,
        z
      } = calculateXYZPosition(node, nodeInternals, __spreadProps(__spreadValues({}, node.position), {
...
function createNodeInternals(nodes, nodeInternals, nodeOrigin, elevateNodesOnSelect) {
  ...
  nodes.forEach((node) => {
    ...
    const internals = __spreadProps(__spreadValues({}, node), {
      positionAbsolute: {
        x: node.position.x,
        y: node.position.y
      }
...
function handleControlledNodeSelectionChange(nodeChanges, nodeInternals) {
  nodeChanges.forEach((change) => {
    ...
    if (node) {
      nodeInternals.set(node.id, __spreadProps(__spreadValues({}, node), {
...
function useReactFlow() {
  ...
  const getNodes = (0, import_react2.useCallback)(() => {
    return store.getState().getNodes().map((n) => __spreadValues({}, n));
  }, []);
  ...
  const getEdges = (0, import_react2.useCallback)(() => {
    ...
    return edges.map((e) => __spreadValues({}, e));
  }, []);
  ...
  const toObject = (0, import_react2.useCallback)(() => {
    ...
    return {
      nodes: getNodes2().map((n) => __spreadValues({}, n)),
      edges: edges.map((e) => __spreadValues({}, e)),
      viewport: {
        x,
        y,
        zoom
  ...
  const deleteElements = (0, import_react2.useCallback)(({
    nodes: nodesDeleted,
    edges: edgesDeleted
  }) => {
    const {
  ...
  return (0, import_react2.useMemo)(() => {
    return __spreadProps(__spreadValues({}, viewportHelper), {
      getNodes,
      getNode,
      getEdges,
      getEdge,
...
var ZoomPane = ({
  ...
  const prevTransform = (0, import_react2.useRef)({
    x: 0,
    y: 0,
    zoom: 0
  });
...
function handleParentExpand(res, updateItem) {
  ...
  if (parent) {
    ...
    if (extendWidth > 0 || extendHeight > 0 || updateItem.position.x < 0 || updateItem.position.y < 0) {
      parent.style = __spreadValues({}, parent.style) || {};
...
function applyChanges(changes, elements) {
  ...
  return elements.reduce((res, item) => {
    ...
    const updateItem = __spreadValues({}, item);
        ...
        switch (currentChange.type) {
          ...
          case "dimensions": {
            ...
            if (typeof currentChange.updateStyle !== "undefined") {
              updateItem.style = __spreadValues(__spreadValues({}, updateItem.style || {}), currentChange.dimensions);
            }
...
var Pane = (0, import_react2.memo)(({
  ...
  const onMouseMove = (event) => {
    ...
    const nextUserSelectRect = __spreadProps(__spreadValues({}, userSelectionRect), {
  ...
  return import_react2.default.createElement("div", {
    ...
    ref: container,
    style: containerStyle
  }, children2, import_react2.default.createElement(UserSelection, null));
});
...
function hasSelector(target, selector6, nodeRef) {
  let current = target;
  do {
    if (current?.matches(selector6)) return true;
...
function getMouseHandler(id2, getState, handler) {
  return handler === void 0 ? handler : (event) => {
    ...
    if (node) {
      handler(event, __spreadValues({}, node));
    }
  };
}
...
function useGetPointerPosition() {
  const store = useStoreApi();
  const getPointerPosition = (0, import_react2.useCallback)(({
    sourceEvent
  }) => {
    const {
      transform: transform2,
    ...
    const nodeUpdates = selectedNodes.map((n) => {
      if (n.positionAbsolute) {
        ...
        const {
          positionAbsolute,
          position
        } = calcNextPosition(n, nextPosition, nodeInternals, nodeExtent, void 0, onError);
        n.position = position;
  ...
  const NodeWrapper = ({
    ...
    const onSelectNodeHandler = (event) => {
      ...
      if (onClick) {
        ...
        if (node) {
          onClick(event, __spreadValues({}, node));
        }
      }
    };
    ...
    }, import_react2.default.createElement(Provider, {
      value: id2
    }, import_react2.default.createElement(NodeComponent, {
      id: id2,
      data,
      type,
      xPos,
...
var selector$7 = (s) => {
  ...
  return __spreadProps(__spreadValues({}, getNodesBounds(selectedNodes, s.nodeOrigin)), {
...
var FlowRenderer = ({
  ...
  return import_react2.default.createElement(ZoomPane, {
    onMove,
    onMoveStart,
    onMoveEnd,
    onPaneContextMenu,
    ...
    noWheelClassName,
    noPanClassName
  }, import_react2.default.createElement(Pane, {
    onSelectionStart,
    onSelectionEnd,
    onPaneClick,
    onPaneMouseEnter,
    ...
    selectionMode
  }, children2, nodesSelectionActive && import_react2.default.createElement(NodesSelection$1, {
    onSelectionContextMenu,
    noPanClassName,
    disableKeyboardA11y
  })));
...
function useVisibleNodes(onlyRenderVisible) {
  const nodes = useStore((0, import_react2.useCallback)((s) => onlyRenderVisible ? getNodesInside(s.nodeInternals, {
    x: 0,
    y: 0,
    width: s.width,
    height: s.height
...
function createNodeTypes(nodeTypes) {
  ...
  return __spreadValues(__spreadValues({}, standardTypes), specialTypes);
}
var getPositionWithOrigin = ({
  x,
  y,
  width,
  height,
...
var NodeRenderer = (props) => {
  ...
  return import_react2.default.createElement("div", {
    ...
    return import_react2.default.createElement(NodeComponent, {
      key: node.id,
      id: node.id,
...
var wrapEdge = (EdgeComponent) => {
  const EdgeWrapper = ({
    ...
    return import_react2.default.createElement("g", {
      ...
      ref: edgeRef
    }, !updating && import_react2.default.createElement(EdgeComponent, {
      id: id2,
      source,
      target,
      selected,
      ...
      pathOptions,
      interactionWidth
    }), isReconnectable && import_react2.default.createElement(import_react2.default.Fragment, null, (isReconnectable === "source" || isReconnectable === true) && import_react2.default.createElement(EdgeAnchor, {
      position: sourcePosition,
      centerX: sourceX,
      centerY: sourceY,
      ...
      type: "source"
    }), (isReconnectable === "target" || isReconnectable === true) && import_react2.default.createElement(EdgeAnchor, {
      position: targetPosition,
      centerX: targetX,
      centerY: targetY,
      radius: reconnectRadius,
...
var ArrowSymbol = ({
  ...
  return import_react2.default.createElement("polyline", {
    style: {
      stroke: color2,
      strokeWidth
    },
...
var Marker = ({
  ...
  return import_react2.default.createElement("marker", {
    ...
    refX: "0",
    refY: "0"
  }, import_react2.default.createElement(Symbol2, {
    color: color2,
    strokeWidth
  }));
};
    ...
    [edge.markerStart, edge.markerEnd].forEach((marker) => {
      if (marker && typeof marker === "object") {
        ...
        if (!ids.includes(markerId)) {
          markers.push(__spreadValues({
            id: markerId,
            color: marker.color || defaultColor2
          }, marker));
          ids.push(markerId);
        }
      }
...
var MarkerDefinitions = ({
  ...
  const markers = useStore(
    (0, import_react2.useCallback)(markerSelector({
      defaultColor: defaultColor2,
      rfId
    }), [defaultColor2, rfId]),
  ...
  return import_react2.default.createElement("defs", null, markers.map((marker) => import_react2.default.createElement(Marker, {
    id: marker.id,
    key: marker.id,
    type: marker.type,
    color: marker.color,
...
var EdgeRenderer = ({
  ...
  const {
    ...
    nodeInternals,
    onError
  } = useStore(selector$4, shallow$1);
  const edgeTree = useVisibleEdges(onlyRenderVisibleElements, nodeInternals, elevateEdgesOnSelect);
  if (!width) {
    return null;
  }
  return import_react2.default.createElement(import_react2.default.Fragment, null, edgeTree.map(({
    level,
    edges,
    isMaxLevel
  ...
  }, isMaxLevel && import_react2.default.createElement(MarkerDefinitions$1, {
...
var ConnectionLine = ({
  ...
  const {
    ...
    toY,
    connectionMode
  } = useStore((0, import_react2.useCallback)((s) => ({
  ...
  if (CustomComponent) {
    return import_react2.default.createElement(CustomComponent, {
...
function ConnectionLineWrapper({
  ...
  }, import_react2.default.createElement(ConnectionLine, {
    nodeId,
    handleType,
    style: style2,
    type,
...
var GraphView = ({
  ...
  return import_react2.default.createElement(FlowRenderer$1, {
    onPaneClick,
    onPaneMouseEnter,
    onPaneMouseMove,
    onPaneMouseLeave,
    ...
    noPanClassName,
    disableKeyboardA11y
  }, import_react2.default.createElement(Viewport, null, import_react2.default.createElement(EdgeRenderer$1, {
    ...
    disableKeyboardA11y,
    rfId
  }, import_react2.default.createElement(ConnectionLineWrapper, {
  ...
  }), import_react2.default.createElement(NodeRenderer$1, {
...
var createRFStore = () => createWithEqualityFn((set3, get3) => __spreadProps(__spreadValues({}, initialState), {
  setNodes: (nodes) => {
    const {
      nodeInternals,
      nodeOrigin,
  ...
  setEdges: (edges) => {
    ...
    set3({
      edges: edges.map((e) => __spreadValues(__spreadValues({}, defaultEdgeOptions), e))
    });
  },
  ...
  updateNodeDimensions: (updates) => {
    ...
    const changes = updates.reduce((res, update) => {
      ...
      if (node?.hidden) {
        nodeInternals.set(node.id, __spreadProps(__spreadValues({}, node), {
          [internalsSymbol]: __spreadProps(__spreadValues({}, node[internalsSymbol]), {
        ...
        if (doUpdate) {
          nodeInternals.set(node.id, __spreadValues(__spreadProps(__spreadValues({}, node), {
            [internalsSymbol]: __spreadProps(__spreadValues({}, node[internalsSymbol]), {
              handleBounds: {
    ...
    const nextFitViewOnInitDone = fitViewOnInitDone || fitViewOnInit && !fitViewOnInitDone && fitView(get3, __spreadValues({
      initial: true
    }, fitViewOnInitOptions));
    set3({
      nodeInternals: new Map(nodeInternals),
  ...
  reset: () => set3(__spreadValues({}, initialState))
}), Object.is);
var ReactFlowProvider = ({
  children: children2
}) => {
  ...
  return import_react2.default.createElement(Provider$1, {
...
var ReactFlow = (0, import_react2.forwardRef)((_a, ref) => {
  var _b = _a, {
    nodes,
    edges,
    defaultNodes,
  ...
  const rfId = id2 || "1";
  return import_react2.default.createElement("div", __spreadProps(__spreadValues({}, rest), {
    style: __spreadValues(__spreadValues({}, style2), wrapperStyle),
    ref,
    className: cc(["react-flow", className]),
    "data-testid": "rf__wrapper",
    id: id2
  }), import_react2.default.createElement(Wrapper, null, import_react2.default.createElement(GraphView$1, {
    onInit,
    onMove,
    onMoveStart,
    onMoveEnd,
    ...
    nodeOrigin,
    nodeExtent
  }), import_react2.default.createElement(StoreUpdater, {
    nodes,
    edges,
    defaultNodes,
    defaultEdges,
    ...
    isValidConnection,
    nodeDragThreshold
  }), import_react2.default.createElement(Wrapper$1, {
    onSelectionChange
  }), children2, import_react2.default.createElement(Attribution, {
    proOptions,
    position: attributionPosition
  }), import_react2.default.createElement(A11yDescriptions, {
    rfId,
    disableKeyboardA11y
  })));
});
...
function MiniMapNodes({
  ...
  return import_react3.default.createElement(import_react3.default.Fragment, null, nodes.map((node) => {
    ...
    return import_react3.default.createElement(NodeComponent, {
      key: node.id,
      x,
      y,
      width: node.width,
...
function MiniMap({
  ...
  (0, import_react3.useEffect)(() => {
    if (svg.current) {
      ...
      const panHandler = (event) => {
        ...
        const extent = [[0, 0], [width2, height2]];
  ...
  return import_react3.default.createElement(Panel, {
    position,
    style: style2,
    ...
    ref: svg,
    onClick: onSvgClick
  }, ariaLabel && import_react3.default.createElement("title", {
    id: labelledBy
  }, ariaLabel), import_react3.default.createElement(MiniMapNodes$1, {
...
var ControlButton = (_a) => {
  ...
  return import_react4.default.createElement("button", __spreadValues({
    type: "button",
...
var Controls = ({
  ...
  return import_react4.default.createElement(Panel, {
...
function Background({
  ...
  }, import_react5.default.createElement("pattern", {
    id: patternId + id2,
  ...
  }, isDots ? import_react5.default.createElement(DotPattern, {
    color: patternColor,
    radius: scaledSize / offset
  }) : import_react5.default.createElement(LinePattern, {
...
function getTransform(nodeRect, transform2, position, offset, align) {
  ...
  let pos = [(nodeRect.x + nodeRect.width * alignmentOffset) * transform2[2] + transform2[0], nodeRect.y * transform2[2] + transform2[1] - offset];
  let shift = [-100 * alignmentOffset, -100];
  switch (position) {
    case Position.Right:
      pos = [(nodeRect.x + nodeRect.width) * transform2[2] + transform2[0] + offset, (nodeRect.y + nodeRect.height * alignmentOffset) * transform2[2] + transform2[1]];
    ...
    case Position.Bottom:
      ...
      break;
    case Position.Left:
      pos = [nodeRect.x * transform2[2] + transform2[0] - offset, (nodeRect.y + nodeRect.height * alignmentOffset) * transform2[2] + transform2[1]];
      shift = [-100, -100 * alignmentOffset];
      break;
  }
  return `translate(${pos[0]}px, ${pos[1]}px) translate(${shift[0]}%, ${shift[1]}%)`;
}
function NodeToolbar(_a) {
  var _b = _a, {
    nodeId,
    children: children2,
    className,
  ...
  const {
    ...
    nodeOrigin,
    selectedNodesCount
  } = useStore(storeSelector, shallow$1);
  ...
  const wrapperStyle2 = __spreadValues({
    position: "absolute",
    transform: getTransform(nodeRect, transform2, position, offset, align),
    zIndex
  }, style2);
  return import_react6.default.createElement(NodeToolbarPortal, null, import_react6.default.createElement("div", __spreadValues({
    style: wrapperStyle2,
...
function ResizeControl({
  ...
  (0, import_react7.useEffect)(() => {
    ...
    const dragHandler = drag_default().on("start", (event) => {
      ...
      startValues.current = __spreadProps(__spreadValues({}, prevValues.current), {
        pointerX: xSnapped,
        pointerY: ySnapped,
        aspectRatio: prevValues.current.width / prevValues.current.height
      });
      onResizeStart?.(event, __spreadValues({}, prevValues.current));
    }).on("drag", (event) => {
      const {
        nodeInternals,
        triggerNodeChanges
      ...
      if (node) {
        ...
        const nextValues = __spreadProps(__spreadValues({}, prevValues.current), {
          direction
        });
      ...
      onResizeEnd?.(event, __spreadValues({}, prevValues.current));
  ...
  }, [id2, controlPosition, minWidth, minHeight, maxWidth, maxHeight, keepAspectRatio, getPointerPosition, onResizeStart, onResize, onResizeEnd]);
  const positionClassNames = controlPosition.split("-");
  const colorStyleProp = variant === ResizeControlVariant.Line ? "borderColor" : "backgroundColor";
  const controlStyle = color2 ? __spreadProps(__spreadValues({}, style2), {
...
function NodeResizer({
  ...
  return import_react7.default.createElement(import_react7.default.Fragment, null, lineControls.map((c) => import_react7.default.createElement(ResizeControl$1, {
    key: c,
    ...
    onResize,
    onResizeEnd
  })), handleControls.map((c) => import_react7.default.createElement(ResizeControl$1, {
    key: c,
